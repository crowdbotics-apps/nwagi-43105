"""
Django settings for nwagi_43105 project.
...
WSGI_APPLICATION = 'nwagi_43105.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "nwagi_43105 API",
    "DESCRIPTION": "API documentation for nwagi_43105 App",
    "VERSION": "v1",
}
